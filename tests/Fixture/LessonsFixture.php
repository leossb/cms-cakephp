...
class LessonsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cover' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'topic_id' => 1,
                'created' => '2020-04-01 18:16:47',
                'modified' => '2020-04-01 18:16:47',
            ],
        ];
        parent::init();
    }
