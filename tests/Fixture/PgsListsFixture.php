 ...
 * PgsListsFixture
 */
class PgsListsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'subtitle' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'pg_id' => 1,
                'created' => '2020-07-12 19:52:15',
                'modified' => '2020-07-12 19:52:15',
            ],
        ];
        parent::init();
    }
